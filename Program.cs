...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        int n1, d1, n2, d2;
        Console.WriteLine("Уведіть чисельник першого дроба:");
        n1 = Convert.ToInt32(Console.ReadLine());
        Console.WriteLine("Уведіть знаменник першого дроба:");
        d1 = Convert.ToInt32(Console.ReadLine());
        Console.WriteLine("Уведіть чисельник другого дроба:");
        n2 = Convert.ToInt32(Console.ReadLine());
        Console.WriteLine("Уведіть знаменик другого дроба:");
        ...
        Console.WriteLine($"\n\nРезультат операцій з дробами {a.ToString()} та {b.ToString()}:");
